...
public class TestBase {
    ...
    protected static ApplicationManager app =
            new ApplicationManager(System.getProperty("browser",
                    Browser.CHROME.browserName()));//ubrali final - brauser, kotoriy sapuskaetsya po umilchaniyu

    //@BeforeMethod //kazhdiy ras pered kazhdim metodom
    @BeforeSuite //odin ras na vse testi
    public void setUp() {
        app.init();
    }

    //@AfterMethod(enabled = false)// enabled = false - chtobi okno ne sakrivalos'
    @AfterSuite
